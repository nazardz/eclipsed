if EID then -- External Item Description
	...
	EID:addCollectible(enums.Items.DiceBombs,
			"+5 bombs when picked up. #The placed bomb will reroll pickups, chests and items within explosion range. #33% chance to remove item on reroll. #Devolve enemies hit by an explosion.")

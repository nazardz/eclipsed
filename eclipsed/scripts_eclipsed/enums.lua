...
enums.Items.Ignite = Isaac.GetItemIdByName("Ignite") -- abihu pocket item, create ring of blue fire and pulls Nadab's body to abihu
enums.Items.SteroidMeat = Isaac.GetItemIdByName("Steroid Meat") -- +1 hp, turn all hearts into heart containers, dmg up for hearts count
enums.Items.HolyRavioli = Isaac.GetItemIdByName("Holy Ravioli") -- taking damage creates pink charming creep
enums.Items.Shroomface = Isaac.GetItemIdByName("Shroomface") -- each 6 seconds create 3 homing spores around you
enums.Items.AngryMeal = Isaac.GetItemIdByName("Angry Meal") -- +1hp, activate berserk when you die and removed
enums.Items.BaconPancakes = Isaac.GetItemIdByName("Bacon Pancakes") -- all stats up
enums.Items.BabylonCandle = Isaac.GetItemIdByName("Babylon Candle") -- teleport to treasure room and reroll item into Planetarium item
enums.Items.MephistoPact = Isaac.GetItemIdByName("Mephisto's Pact") -- add 3 broken hearts, all devil deals is free
enums.Items.GlitterInjection = Isaac.GetItemIdByName("Glitter Injection") -- shoot pink tear, when it kills enemy - spawn pickups of each type and shoot ring of enemy tears
